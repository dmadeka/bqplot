...
class Objects(Mark):
    ...
    def _handle_custom_msgs(self, _, content, buffers=None):
        ...
        super(Objects, self)._handle_custom_msgs(self, content)

    _view_name = Unicode('Objects').tag(sync=True)
    _model_name = Unicode('ObjectsModel').tag(sync=True)
